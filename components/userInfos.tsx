...
function UserInfos({ userData }: { userData: UserType }) {
    ...
    const [selectedCursusData, setSelectedCursusData] = useState<UserType['cursus_users'][0] | undefined>(userData.cursus_users[0] ? userData.cursus_users[0] : undefined);
    const [selectedCursusProjects, setSelectedCursusProjects] = useState<UserType['projects_users']>([]);
            ...
            <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} >
                ...
                <View>
                    ...
                    <Picker
                        ...
                        onValueChange={(itemValue, itemIndex) => setSelectedCursus(itemValue)}
                    >
                ...
                <View style={styles.section}>
                    {selectedCursusProjects.length > 0 && (
                        <>
                            <Text style={styles.title}>Projects</Text>
                            {selectedCursusProjects.map(project => (
